...
VALUES
    ('NCC001', N'Nhà cung cấp thịt bò', '0123456789', 'nccthitbo@example.com', N'24 Đường Hải Bà Trưng, Quận 10, TP.HCM', N'Thịt bò', 4.5),
    ('NCC002', N'Nhà cung cấp bún gạo', '0987654321', 'nccbungao@example.com', N'9 Đường Nguyễn Huệ, Quận 5, TP.HCM', N'Bún gạo', 4.2),
    ('NCC003', N'Nhà cung cấp thịt heo', '0112233445', 'nccthitheo@example.com', N'57 Đường Cách Mạng Tháng Tám, Quận Bình Thạnh, TP.HCM', N'Thịt heo', 4.7),
    ('NCC004', N'Nhà cung cấp bánh mì', '0112222333', 'nccbanhmi@example.com', N'79 Đường Lê Duẩn, Quận 1, TP.HCM', N'Bánh mì', 4.0),
    ('NCC005', N'Nhà cung cấp cua tươi', '0989012345', 'ncccuatuoi@example.com', N'46 Đường Lý Tự Trọng, Quận 1, TP.HCM', N'Cua tươi', 4.8),
    ('NCC006', N'Nhà cung cấp gạo nấu cơm', '0978901234', 'nccgao@example.com', N'89 Đường Bến Thành, Quận 1, TP.HCM', N'Gạo nấu cơm', 4.6),
    ('NCC007', N'Nhà cung cấp tôm tươi', '0967890123', 'ncctomtuoi@example.com', N'13 Đường Võ Văn Tần, Quận 3, TP.HCM', N'Tôm tươi', 4.9);
